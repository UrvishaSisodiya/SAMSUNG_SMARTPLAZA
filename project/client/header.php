...
<head>
    ...
    <style>
	 header {
      ...
      position: relative;
      background: url('project_image/b2.jpg') no-repeat center center/cover;
      color: black;
      padding: 40px 0;
...
<body>
 <!-- svg icon -->
    ...
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
        ...
        <symbol id="navbar-icon" viewBox="0 0 24 24">
  ...
  <header id="header" class=" bg-black text-white site-header py-3 px-3 px-lg-5 position-absolute top-0 start-0 w-100 z-1">

        <div class="container-fluid">
            <div class="row">
                <nav class="navbar navbar-expand-lg">
                    <button class="navbar-toggler d-flex d-lg-none order-3 p-0 border-0 shadow-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#bdNavbar" aria-controls="bdNavbar" aria-expanded="false" aria-label="Toggle navigation">
                        <svg class="navbar-icon text-white" width="30" height="30">
                            <use xlink:href="#navbar-icon"></use>
                      </svg>
                    </button>
                    <a href="#" class="navbar-brand order-2 order-lg-2 d-flex d-lg-none">
                        <img src="project_image/logo.jpg" alt="Logo">
                    </a>
                    <div class="offcanvas offcanvas-end bg-black order-3" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
                        <div class="offcanvas-body align-items-center">
                            <div class="offcanvas-header p-0 py-4 ms-2">
                                <button type="button" class="btn-close btn-close-white shadow-none" data-bs-dismiss="offcanvas" aria-label="Close" data-bs-target="#bdNavbar"></button>
                            </div>
                            <div class="col-md-2 d-flex">
                                <a href="#" class="navbar-brand order-2 order-lg-2 d-none d-lg-flex">
                                    <img src="project_image/logo.jpg" alt="Logo" height="100" width="150">
                                </a>
                            </div>
                                ...
                                <div class="navbar-collapse order-1 order-lg-1 ms-3 ms-lg-0" id="navbarMenu">
                                    <ul class="navbar-nav d-flex justify-content-center">
                                        <li class="nav-item me-5">
                                            <a class="nav-link nav-link-ltr text-white pb-1 pe-0" href="home.php">Home</a>
                                        </li>
                                        <li class="nav-item me-5">
                                            <a class="nav-link nav-link-ltr text-white pb-1 pe-0" href="about.php">About</a>
                                        </li>

                                        <!-- Dropdown for category -->
										<li class="nav-item me-5 dropdown">
                                           <a class="nav-link nav-link-ltr text-white pb-1 pe-0 dropdown-toggle show" href="#" id="navbarDropdownShop" role="button" data-bs-toggle="dropdown" aria-expanded="true">
                                           Shop
                                              </a>
                                            <ul class="dropdown-menu" aria-labelledby="navbarDropdowncategory">
											    <li><a href="other.php" class="dropdown-item">All Product</a></li>
                                                <li><a href="smartphone.php" class="dropdown-item" >Smartphone</a></li>
                                                 <li><a href="smartwatch.php" class="dropdown-item">Smartwatch</a></li>
                                                 <li><a href="laptop.php" class="dropdown-item">Laptop</a></li>
                                                        <li><a href="buds.php" class="dropdown-item">Buds</a></li>
                                                <li><a href="speaker.php" class="dropdown-item">Speaker</a></li>
                                               <li><a href="tv.php" class="dropdown-item">TV</a></li>
                                               <li><a href="camera.php" class="dropdown-item">Camera</a></li>
                                               <li><a href="fridge.php" class="dropdown-item">Fridge</a></li>
                                               <li><a href="tablet.php" class="dropdown-item">Tablet</a></li>
                                         ...
                                         <li class="nav-item me-5">
                                            <a class="nav-link nav-link-ltr text-white pb-1 pe-0" href="contact_us.php">Contact</a>
                                        </li>
                                           <!-- Dropdown for FeedBack -->
                                        <li class="nav-item me-5">
                                            <a class="nav-link nav-link-ltr text-white pb-1 pe-0" href="feedback.php" >FeedBack</a>
                                        </li>
										<li class="nav-item me-5">
                                            <a class="nav-link nav-link-ltr text-white pb-1 pe-0" href="logout.php" >Logout</a>
                                        </li>
                                    </ul>
                            ...
                            <div class="col-md-3">
                                <ul class="user-items list-unstyled d-none d-lg-flex justify-content-end align-items-center order-3 flex-grow-1 gap-4 m-0">
                                    <li class="search-item" data-bs-toggle="collapse" data-bs-target="#search-box" aria-controls="search-box" aria-expanded="false" aria-label="Toggle navigation">
                                        <a href="search.php" class="search-button">
                                            <svg class="text-white search" width="20" height="20">
                                    ...
                                    <li>
                                        <a href="viewcart.php">
                                            <svg class="text-white cart" width="20" height="20">
                                    ...
                                    <li>
                                        <a href="registration.php">
                                            <svg class="text-white man" width="20" height="20">
