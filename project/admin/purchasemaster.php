...
<?php
	...
	<h1 align='center'><font color='#CC7A8B'size='+5'><u> PURCHASE MASTER </u></font></h1>
	...
	<th><font color='#CC6666' size='+2'><ul>Item Name</font></ul></th>
	<th><font color='#CC6666' size='+2'><ul>Total</font></ul></th>
	<th><font color='#CC6666' size='+2'><ul>Payment</font></ul></th>
	<th><font color='#CC6666' size='+2'>pur_date</font></ul></th>
	...
	while($row=mysqli_fetch_array($result))
	{
		...
		echo "</td><td>";
		echo $row["pur_date"];
		echo "</td><td><a href='purchasedelete.php?id=".$row[0]."'><ul><img src='project_image/deleteicon.png'></img> </ul></a></td>";
	}
	echo"</tr></table>";
?>
